...
session_start();
	...
	if(isset($_POST['simpan'])){
		...
		$simpan = mysql_query("INSERT INTO show_list(id_show,nama_show,jam_tayang,jam_tayang2) VALUES (NULL,'$nama_show','$jam_tayang','$jam_tayang2')");
	...
	if(isset($_POST['update'])){
		...
		$sqlupdate = mysql_query("UPDATE show_list SET nama_show='$nama_show1', jam_tayang='$jam_tayang1', jam_tayang2='$jam_tayang2' WHERE id_show = '$id1'");
