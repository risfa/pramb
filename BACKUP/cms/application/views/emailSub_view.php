      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav">
            ...
            <li> <a href="<?php echo base_url() ?>book/emailSub">Email Subscriber</a></li>
          </ul>
...
<!-- /.end -->
  ...
  <div class="container">
    ...
    <br />
    <button class="btn btn-success" onclick="add_book()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>
    <br />
    <br />
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      <thead>
        <tr>
          ...
          <th>eemail_id_sub</th>
          <th>eemail_name_sub</th>
          <th>eemail_email_sub</th>
          <!-- <th>post_content</th> -->
          <th>eemail_status_sub</th>
          <th>eemail_date_sub</th>
      ...
      <tbody>
				<?php foreach($books as $book){?>
				     <tr>
				         <td><?php echo $book->eemail_id_sub;?></td>
                 <td><?php echo $book->eemail_name_sub;?></td>
                 <td><?php echo $book->eemail_email_sub;?></td>
                 <!-- <td><?php //echo $book->post_content;?></td> -->
                <td><?php echo $book->eemail_status_sub;?></td>
                <td><?php echo $book->eemail_date_sub ;?></td>
								<td>
									<button class="btn btn-warning" onclick="edit_book(<?php echo $book->eemail_id_sub;?>)"><i class="glyphicon glyphicon-pencil"></i></button>
									<button class="btn btn-danger" onclick="delete_book(<?php echo $book->eemail_id_sub;?>)"><i class="glyphicon glyphicon-remove"></i></button>
    ...
    function edit_book(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="ID"]').val(data.ID);
            $('[name="post_type"]').val(data.post_type);
