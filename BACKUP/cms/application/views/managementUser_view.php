...
<!-- /.end -->
  ...
  <div class="container">
    ...
    <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
      ...
      <tbody>
                ...
                <td><?php echo $book->credential;?></td>
								<td>
  ...
  $( "#cancel-form" ).click(function() {
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('index.php/book/managementUserAdd')?>";
      }
      else
      {
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="status" placeholder="AE(Account Executive)" class="form-control" type="text">
              </div>
            </div>
