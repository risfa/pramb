...
<body class="onepage front" data-spy="scroll" data-target="#top1" data-offset="92">
    ...
    <div id="main">
        ...
        <div class="container" class="backdrop">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 style="color: #ffc925; font-weight: bold; font-size: 40px; line-height: 80%"><?php echo $data_news_1[4] ?></h1>
                    <font style="color: white;">By <?php echo $data_news_1[1]; ?> | <?php echo $data_news_1[2] ?></font>   
                </div>
            </div>
            <br><br>
            <div class="row">
                <div class="col-md-9">
                    <div class="post post-short" style="margin-top: -35px;"> 
                        ...
                        <div class="post-story" style="color: white;">
                            <div class="post-story-body clearfix">
                                <p class="txt1" style="font-size: 20px; color: white;">
                                    <?php echo htmlspecialchars_decode($data_news_1[3]) ?><br>
                                </p>
                            </div>
                        </div>
                        <?php 
                        ...
                        <div class="row" style="text-align: center;">
                            <?php  if($prevcount>0){ ?>
                            <div class="col-md-4 col-sm-4 col-xs-4"><a style="color: #fdc416; text-decoration: none; font-weight: bold;" href="news_details.php?details=<?php echo $dataprev[0] ?>">Previous <i class="angle-double-left"></i></a></div>
                            <?php } ?>
                            
                            <div class="col-md-4 col-sm-4 col-xs-4"><a style="color: #fdc416; text-decoration: none; font-weight: bold;" href="news.php">News Feed</a></div>
                            
                            <?php if($nextcount>0){ ?>
                            <div class="col-md-4 col-sm-4 col-xs-4"><a style="color: #fdc416; text-decoration: none; font-weight: bold;" href="news_details.php?details=<?php echo $datanext[0] ?>">Next <i class="angle-double-right"></i></a></div>
                            <?php } ?>
                        </div>
                    </div>
